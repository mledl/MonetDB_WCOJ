...
mal_export void traceInstruction(component_t comp, MalBlkPtr mb, MalStkPtr stk, InstrPtr p, int flg);
// mal_export void traceMALBlk(component_t comp, MalBlkPtr mb, MalStkPtr stk, int flg);
