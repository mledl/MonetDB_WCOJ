...
if __name__ == "__main__":
  ...
  for idx, key in enumerate(data_avg):
    ...
    df = df.drop('m', axis=1)
    df_scalar = df.set_index('fanout')

    ax = df_scalar.plot(title=key + '\nm = ' + str(data_avg[key]['m'][0]))
